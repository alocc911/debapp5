...
=======
  !((activeParticipants.size === 0 || activeParticipants.has(n.data.participantId)) &&
    (activeKinds.size === 0 || activeKinds.has(n.data.kind)) &&
    (store.filters.strengths.size === 0 || !n.data.strengthType || store.filters.strengths.has(n.data.strengthType)))
).map(n => n.id))
  }, [store.nodes, activeParticipants, activeKinds, filterMode, hasFilters])

  const baseVisible = React.useMemo(
    () => nodes.filter(n => !hiddenDueToCollapse.has(n.id) && !hiddenDueToFilters.has(n.id)),
    [nodes, hiddenDueToCollapse, hiddenDueToFilters]
>>>>>>> a32c1e012b8e1109de46231cdcbc3e25605c0216
  )
...
=======
      const sHidden = hiddenDueToCollapse.has(e.source) || hiddenDueToFilters.has(e.source)
      const tHidden = hiddenDueToCollapse.has(e.target) || hiddenDueToFilters.has(e.target)
      if (sHidden || tHidden) return false
      return true
    })
  }, [edges, hiddenDueToCollapse, hiddenDueToFilters])
>>>>>>> a32c1e012b8e1109de46231cdcbc3e25605c0216
...
=======
  ...
  ((activeParticipants.size > 0 && !activeParticipants.has(n.data.participantId)) ||
   ...
   (store.filters.strengths.size > 0 && (!n.data.strengthType || !store.filters.strengths.has(n.data.strengthType)))))
    ...
    store.linkHighlight, store.filters, filterMode, hasFilters]) // Add filters dependency
>>>>>>> a32c1e012b8e1109de46231cdcbc3e25605c0216
